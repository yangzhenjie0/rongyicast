...
public class PraiseListView extends TextView{
    ...
    private List<ArtWorkPraise> datas;
    ...
    public List<ArtWorkPraise> getDatas() {
        return datas;
    }
    public void setDatas(List<ArtWorkPraise> datas) {
        this.datas = datas;
    ...
    private SpannableString setImageSpan(){
        ...
        imgSpanText.setSpan(new ImageSpan(AppApplication.getSingleContext(), R.mipmap.praise_creat, DynamicDrawableSpan.ALIGN_BASELINE),
